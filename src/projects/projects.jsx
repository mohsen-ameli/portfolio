...
const Card = ({ img, title, url1, url2, body1, body2 }) => {
  ...
  return (
    ...
    >
      {/* Image */}
      <div
        className="md:w-1/2 h-[12rem] md:h-[23rem] bg-cover bg-center bg-no-repeat bg-origin-content group rounded-lg"
      ...
      <div className="self-center w-full py-4">
        ...
        <p className="text-lg leading-relaxed p-4 select-text">
          ...
          <button
            className="mx-2 px-1 text-sm btn text-[#FF5F1F] border-2 border-[#FF5F1F] rounded-sm hover:bg-[#FF5F1F] hover:text-white hover:scale-105 duration-150"
        ...
        <div className="flex justify-center">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="cursor-pointer mt-4 py-2 px-4 mx-4 flex items-center justify-center btn font-semibold text-[#FF5F1F] border-2 border-[#FF5F1F] rounded-lg hover:bg-[#FF5F1F] hover:text-white hover:scale-105 duration-150"
          >
